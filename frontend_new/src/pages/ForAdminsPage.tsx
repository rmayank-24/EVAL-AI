  ...
  return (
    <StyleWrapper>
      ...
      <div className="bg-[#0A0F18] text-gray-300 min-h-screen overflow-x-hidden relative">
        ...
        <Particles id="tsparticles-admins" init={particlesInit} options={particlesOptions} />
        <div className="relative z-10">
          ...
          <main className="container mx-auto px-6 py-20">
            ...
            >
                ...
                >
                    A powerful, centralized command center for your institution. Manage users, oversee subjects, and monitor school-wide progress with ease.
                </motion.p>
            </motion.div>
            ...
            <div className="mt-24 max-w-4xl mx-auto">
                ...
                >
                    <FeatureDetail 
                        ...
                        description="Onboard new students and teachers in minutes. Easily manage roles and permissions from a single, intuitive dashboard."
                        index={0}
                    />
                    <FeatureDetail 
                        icon={<Shield size={24} />}
                        title="Secure & Centralized"
                        description="Oversee all subjects and assignments across your institution. Ensure consistency and quality while maintaining data privacy and security."
                        index={1}
                    />
                    <FeatureDetail 
                        icon={<BarChart3 size={24} />}
                        title="School-Wide Analytics"
                        description="Access high-level analytics to track engagement, identify trends, and make data-driven decisions for your entire school."
                        index={2}
                    />
                </motion.div>
            </div>
