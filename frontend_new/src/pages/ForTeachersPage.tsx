...
import { BookOpen, Zap, BarChart2, ArrowRight } from 'lucide-react';
  ...
  return (
    <StyleWrapper>
      ...
      <div className="bg-[#0A0F18] text-gray-300 min-h-screen overflow-x-hidden relative">
        ...
        <Particles id="tsparticles-teachers" init={particlesInit} options={particlesOptions} />
        <div className="relative z-10">
          ...
          <main className="container mx-auto px-6 py-20">
            ...
            >
                ...
                >
                    Reclaim your time and amplify your impact. EVAL-AI is your personal teaching assistant, designed to handle the busywork so you can focus on what you do best: teaching.
                </motion.p>
            </motion.div>
            ...
            <div className="mt-24 max-w-4xl mx-auto">
                ...
                >
                    <FeatureDetail 
                        icon={<Zap size={24} />}
                        title="Automate Your Grading"
                        description="Stop spending nights and weekends grading. Create assignments with custom rubrics, and let our AI provide the first round of detailed, consistent feedback in seconds."
                        index={0}
                    />
                    <FeatureDetail 
                        icon={<BookOpen size={24} />}
                        title="Enhance Student Learning"
                        description="Provide every student with immediate, private, and constructive feedback on their work. Help them understand their mistakes and learn faster, without adding to your workload."
                        index={1}
                    />
                    <FeatureDetail 
                        icon={<BarChart2 size={24} />}
                        title="Gain Powerful Insights"
                        description="Track class performance and identify common areas of struggle at a glance. Our analytics help you tailor your teaching to your students' needs."
                        index={2}
                    />
                </motion.div>
            </div>
